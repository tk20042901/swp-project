...
public class CustomerService {
    ...
    public void register(RegisterDto dto) {
        ...
        String autoGeneratedOtp = ThreadLocalRandom.current().nextInt(10000,100000) + "";
        ...
        try {
            CompletableFuture.runAsync(() -> emailService.sendSimpleEmail(dto.getEmail(),
    ...
    public void forgotPassword(String email) {
        ...
        CompletableFuture.runAsync(() -> emailService.sendSimpleEmail(email,
                "Khôi phục mật khẩu",
